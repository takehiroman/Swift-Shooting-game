...
SWIFT_CLASS("_TtC15swiftsimplegame11AppDelegate")
...
SWIFT_CLASS("_TtC15swiftsimplegame9GameScene")
@interface GameScene : SKScene <SKPhysicsContactDelegate>
@property (nonatomic) SKSpriteNode * __null_unspecified sprite;
@property (nonatomic) SKLabelNode * __nonnull scoreLabelNode;
@property (nonatomic) NSInteger score;
@property (nonatomic, readonly) uint32_t bulletCategory;
@property (nonatomic, readonly) uint32_t enemyCategory;
- (void)didMoveToView:(SKView * __nonnull)view;
- (void)shoot;
- (void)createEnemy:(NSUInteger)x;
...
SWIFT_CLASS("_TtC15swiftsimplegame18GameViewController")
...
@interface SKNode (SWIFT_EXTENSION(swiftsimplegame))
